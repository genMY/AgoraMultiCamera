...
func allocateOutputBufferPool(with inputFormatDescription: CMFormatDescription, outputRetainedBufferCountHint: Int) -> (
	...
	outputFormatDescription: CMFormatDescription?) {
		...
		if inputMediaSubType != kCVPixelFormatType_420YpCbCr8BiPlanarFullRange && inputMediaSubType != kCVPixelFormatType_420YpCbCr8BiPlanarFullRange &&
			inputMediaSubType != kCVPixelFormatType_420YpCbCr8BiPlanarFullRange {
